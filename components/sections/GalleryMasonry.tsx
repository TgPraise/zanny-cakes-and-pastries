...
import { Eye, Heart, PartyPopper, GraduationCap, Sparkles, Flower2, Trophy, Palette } from 'lucide-react'

export function GalleryMasonry() {
  const galleryItems = [
    { icon: Heart, title: 'Wedding Elegance', span: 'col-span-1 md:col-span-2' },
    { icon: Sparkles, title: 'Engagement Bliss', span: 'col-span-1' },
    { icon: PartyPopper, title: 'Birthday Magic', span: 'col-span-1' },
    { icon: GraduationCap, title: 'Graduation Glory', span: 'col-span-1 md:col-span-2' },
    ...
    { icon: Palette, title: 'Artistic Masterpiece', span: 'col-span-1 md:col-span-2' },
  ]

  return (
    <section id="gallery" className="w-full py-24 bg-gradient-to-b from-white to-zanny-cream/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Every creation tells a unique story. Browse through our portfolio of celebrations we&apos;ve been honored to create.
          </motion.p>
        </motion.div>
        ...
        >
          {galleryItems.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="relative h-64 md:h-full rounded-2xl overflow-hidden cursor-pointer shadow-soft hover:shadow-premium transition-smooth bg-gradient-to-br from-zanny-red/10 via-zanny-gold/5 to-zanny-cream/10 border border-zanny-gold/20 hover:border-zanny-red/30">
                  {/* Icon Container */}
                  <motion.div
                  ...
                  >
                    ...
                    <div className="relative mb-5">
                      ...
                      <div className="relative w-24 h-24 md:w-28 md:h-28 rounded-full bg-gradient-to-br from-white to-zanny-cream flex items-center justify-center shadow-premium border border-zanny-gold/30">
                        <Icon
                          size={48}
                          strokeWidth={1.5}
